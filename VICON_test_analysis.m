...
subplot(2,2,2)
plot(1:surf_st_comp_samples, surf_st_comp.err_angle,'Color','#5671ba')
grid on
ylim([0 50])
xlabel('sample'); ylabel('error [deg]')
...
subplot(2,2,3)
plot(1:surf_dy_nocomp_samples, surf_dy_nocomp.err_angle,'Color','#5671ba')
grid on
ylim([0 50])
xlabel('sample'); ylabel('error [deg]')
...
subplot(2,2,4)
plot(1:surf_dy_comp_samples, surf_dy_comp.err_angle,'Color','#5671ba')
grid on
ylim([0 50])
xlabel('sample'); ylabel('error [deg]')
...
figure('Position',[1920/3, 1080/3, 500, 500])
